...
| `phase5/infots-supervised-reg-ablation-20260912/` | 正则化修复复训（家族终局） | R1 正控制 FAIL（vol 效应被破坏）；R2 无翻转证据；家族封闭 |
| `phase4ab/formal-oos-20260912/` | 4A/4B 组合层正式 OOS（预注册合同） | 无 challenger 通过；incumbent（NCO risk-only，Sharpe +0.48）冻结 |
