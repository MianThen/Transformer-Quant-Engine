...
## r5 训练包（待 GPU validation）

- 路径：`work/phase2b_feature_pgd_v2_gpu_training_bundle_20260808_r5.tar.gz`
- SHA-256：`91541dbf5957684ff3bd23843c0680b050f06540400783e0f6dbe94e07767895`
- 内容：纯 Feature-PGD、独立 structured-missing control、标准化域 V1 投影、validation-return-guarded
  checkpoint 选择、official/best/last 三件套、prediction/embedding provenance、LF manifest 和 sidecar。
- 审计：归档 hash 与 sidecar 一致；包内 101/101 个 manifest 条目通过；无 cache、runs 或 checkpoint。
- 状态：本机 Python 3.9 编译和非 Torch 测试通过；尚未产生 r5 GPU validation 结果，因此 Phase 2B 状态不变。
